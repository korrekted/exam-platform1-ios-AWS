...
final class GlobalDefinitions {
    ...
    static let apiKey = "hQFvAU5TpF65gGhj"

    static let applicationTag = "EXAM_AWS"
    ...
    static let sdkApiKey = "Cpj8uw8AYgDAeDed"
    
    static let otterScaleHost = "https://api.korrekted.com"
    static let otterScaleApiKey = "m7bChJyZPxvD80nh"

    static let appStoreUrl = "https://apps.apple.com/app/training-for-aws/id1576524128"
    static let appleAppID = "1576524128"
